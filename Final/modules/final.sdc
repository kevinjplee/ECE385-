...
set_input_delay -add_delay  -clock [get_clocks {main_clk_50}]  2.000 [get_ports {SW[0]}]
set_input_delay -add_delay  -clock [get_clocks {main_clk_50}]  2.000 [get_ports {SW[1]}]
set_input_delay -add_delay  -clock [get_clocks {main_clk_50}]  2.000 [get_ports {SW[2]}]
set_input_delay -add_delay  -clock [get_clocks {main_clk_50}]  2.000 [get_ports {SW[3]}]
set_input_delay -add_delay  -clock [get_clocks {main_clk_50}]  2.000 [get_ports {SW[4]}]
set_input_delay -add_delay  -clock [get_clocks {main_clk_50}]  2.000 [get_ports {SW[5]}]
set_input_delay -add_delay  -clock [get_clocks {main_clk_50}]  2.000 [get_ports {SW[6]}]
set_input_delay -add_delay  -clock [get_clocks {main_clk_50}]  2.000 [get_ports {SW[7]}]
